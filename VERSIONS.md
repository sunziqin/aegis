...
| **v6** | **Current Production (Release)** | Qwen2.5-0.5B | **Native C++ SDPA Full Bidirectional (0KB mask)**, Cryptographic Provenance Chain, Calibrated Tri-Gate | `eaf07edd808cecf43473a13e6a331f57bc8d81696f2a1ed7d82dbc7467e01191` | **84.28%** (N=8,657 disjoint) | **Official V6 Model**. 94.16% conformal coverage, 73.95% act rate, 94.36% act precision. |
| **v7** | **In Training (Active)** | Qwen2.5-1.5B | **Permutation Invariance Dual Loss**, Explicit `NO_MATCH` semantic head, 1.5B capacity | *(Training on V100)* | *(Training)* | Directly targets the 51-sample community challenge (eliminating position bias). |
